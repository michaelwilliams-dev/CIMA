...
const DRONE_THREAT_AGENT_BUILD_ISO = "2026-06-22T12:55:00+01:00";
...
function buildDroneThreatResponse(input = {}) {
  ...
  const sourceSupportStatus = !knowledgeSearch && approvedSourceCount === 0
    ...
    : approvedSourceCount > 0
      ? "Source-supported for defensive command, drone-threat incident management or training context only. Human review remains required."
